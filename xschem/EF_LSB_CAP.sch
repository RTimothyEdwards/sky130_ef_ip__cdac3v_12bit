...
C {devices/lab_pin.sym} 460 -820 3 0 {name=p5 sig_type=std_logic lab=Vref}
...
C {devices/lab_pin.sym} 460 -630 3 0 {name=p20 sig_type=std_logic lab=Vref}
...
C {devices/iopin.sym} 930 -1180 0 1 {name=p18 lab=VP1}
C {devices/iopin.sym} 930 -1130 0 1 {name=p23 lab=D0}
C {devices/iopin.sym} 930 -1100 0 1 {name=p24 lab=D1}
C {devices/iopin.sym} 930 -1070 0 1 {name=p25 lab=D2}
C {devices/iopin.sym} 930 -1040 0 1 {name=p26 lab=D3}
C {devices/iopin.sym} 930 -1010 0 1 {name=p27 lab=D4}
C {devices/iopin.sym} 930 -950 0 1 {name=p28 lab=VSS}
...
C {devices/iopin.sym} 930 -980 0 1 {name=p11 lab=D5}
C {devices/iopin.sym} 930 -920 0 1 {name=p12 lab=Vref}
