...
Use 7um x 7.055um cap
(solved for area + perim cap)} 1080 -940 0 0 0.4 0.4 {}
N 1390 -820 1390 -790 {
lab=VSS}
C {sky130_fd_pr/cap_mim_m3_1.sym} 1610 -600 0 1 {name=C13 model=cap_mim_m3_1 W=7 L=7.055 MF=1 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_1.sym} 1390 -605 0 0 {name=C6 model=cap_mim_m3_1 W=7 L=7.055 MF=9 spiceprefix=X}
...
C {sky130_fd_pr/cap_mim_m3_2.sym} 1390 -760 0 0 {name=C1 model=cap_mim_m3_2 W=7 L=7.055 MF=9 spiceprefix=X}
C {sky130_fd_pr/cap_mim_m3_2.sym} 1610 -760 0 0 {name=C2 model=cap_mim_m3_2 W=7 L=7.055 MF=1 spiceprefix=X}
